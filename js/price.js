        $(document).ready(function () {
            ...
            function set_condition(val, condition, id_next) {
                ...
                const unit_none_1 = '<div class="col-sm-3"><div class="input-group"><span class="input-group-addon">單位</span><select class="form-control input-sm"  disabled="disabled" name="unit_' + id_next + '" id="unit_' + id_next + '"><option selected value="0">'
                ...
                const unit_normal = '<div class="col-sm-3"><div class="input-group"><span class="input-group-addon">單位</span><select class="form-control input-sm" name="unit_' + id_next + '" id="unit_' + id_next + '">';
            ...
            function create_conform(mode, val, count, id_next, id_now) {
                ...
                var htm_t = '<tr id = "conform_in_tr_' + id_next + '"><td><div class="row"><div class="' + class_input + '"><div class="input-group"><span class="input-group-addon">' + condition.conform_name + '</span><input class="form-control input-sm" type="text" size="20" name="conform_in_' + id_next + '" id="conform_in_' + id_next + '"></div></div>' + condition.unit;
                var htm_s = '<div class="' + class_degree + '"><div class="input-group"><span class="input-group-addon">符合程度</span><select class="form-control input-sm" name="conform_imp_' + id_next + '" id="conform_imp_' + id_next + '"><option></option><option value="6">完全符合</option><option value="5">非常符合</option><option value="4">比較符合</option><option value="3">普通</option><option value="2">比較不符合</option><option value="1">非常不符合</option><option value="0">完全不符合</option></select></div></div>';
                ...
                $(loc_t).append(htm_t + htm_s + htm_x);
                for(var i = 0; i < count_arr.length; i++){
